...
;------------------------------------------------------------
;	main.c:12: int hex_to_int(char* str)
;	-----------------------------------------
;	 function hex_to_int
;	-----------------------------------------
_hex_to_int:
...
;	-----------------------------------------
_main:
;	main.c:60: ENC_RESET = 1;
;	assignBit
	setb	_P1_0
;	main.c:61: printf("SPI Operations on 8051\n\r");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
